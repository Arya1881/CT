...
export const USERS: User[] = [
  { id: 'u-admin-1', name: 'Dr. Robert Vance (Transport Director)', email: 'admin@campustransit.edu', role: 'ADMIN', phone: '+91 98765 00001', avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150' },
  { id: 'u-driver-1', name: 'Rajesh Kumar', email: 'rajesh.driver@campustransit.edu', role: 'DRIVER', phone: '+91 98765 11101' },
  ...
  { id: 'u-parent-1', name: 'Sunita & Ramesh Sharma', email: 'sharma.parent@gmail.com', role: 'PARENT', phone: '+91 98111 22201' },
  { id: 'u-parent-2', name: 'Vikash Verma', email: 'verma.parent@gmail.com', role: 'PARENT', phone: '+91 98111 22202' },
  { id: 'u-parent-3', name: 'Pooja Gupta', email: 'gupta.parent@gmail.com', role: 'PARENT', phone: '+91 98111 22203' },

  { id: 'u-student-1', name: 'Aarav Sharma', email: 'aarav.sharma@student.edu', role: 'STUDENT', phone: '+91 99000 33301' },
  { id: 'u-student-2', name: 'Ananya Sharma', email: 'ananya.sharma@student.edu', role: 'STUDENT', phone: '+91 99000 33302' },
  { id: 'u-student-3', name: 'Rohan Verma', email: 'rohan.verma@student.edu', role: 'STUDENT', phone: '+91 99000 33303' },
  { id: 'u-student-4', name: 'Priya Gupta', email: 'priya.gupta@student.edu', role: 'STUDENT', phone: '+91 99000 33304' },
  { id: 'u-student-5', name: 'Kabir Das', email: 'kabir.das@student.edu', role: 'STUDENT', phone: '+91 99000 33305' }
];
...
export const STUDENTS: Student[] = [
  { id: 's-1', userId: 'u-student-1', name: 'Aarav Sharma', rollNumber: 'CS-2024-042', gradeDepartment: 'Computer Science (Year 2)', assignedBusId: 'bus-101', assignedStopId: 'stop-3', parentUserId: 'u-parent-1', boardingStatus: 'ON_BOARD' },
  { id: 's-2', userId: 'u-student-2', name: 'Ananya Sharma', rollNumber: 'EC-2025-018', gradeDepartment: 'Electronics (Year 1)', assignedBusId: 'bus-101', assignedStopId: 'stop-3', parentUserId: 'u-parent-1', boardingStatus: 'ON_BOARD' },
  { id: 's-3', userId: 'u-student-3', name: 'Rohan Verma', rollNumber: 'ME-2023-099', gradeDepartment: 'Mechanical Engg (Year 3)', assignedBusId: 'bus-102', assignedStopId: 'stop-4', parentUserId: 'u-parent-2', boardingStatus: 'ON_BOARD' },
  { id: 's-4', userId: 'u-student-4', name: 'Priya Gupta', rollNumber: 'BT-2024-005', gradeDepartment: 'Biotech (Year 2)', assignedBusId: 'bus-103', assignedStopId: 'stop-2', parentUserId: 'u-parent-3', boardingStatus: 'NOT_BOARDED' },
  { id: 's-5', userId: 'u-student-5', name: 'Kabir Das', rollNumber: 'AI-2025-081', gradeDepartment: 'AI & Data Science (Year 1)', assignedBusId: 'bus-104', assignedStopId: 'stop-5', parentUserId: 'u-parent-3', boardingStatus: 'ON_BOARD' }
];
...
export const PARENTS: Parent[] = [
  ...
  { userId: 'u-parent-3', name: 'Pooja Gupta', phone: '+91 98111 22203', email: 'gupta.parent@gmail.com', childrenIds: ['s-4', 's-5'] }
];
